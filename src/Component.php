...
class Component extends BaseComponent
{
    ...
    protected const COMPONENT_NAME = "Registry package";
    protected const COMPONENT_URL = 'https://registry.packages.guzaba.org/';
    ...
    protected const ERROR_REFERENCE_URL = 'https://github.com/AzonMedia/registry/docs/ErrorReference/';
}